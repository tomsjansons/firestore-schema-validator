...
class ModelClass {
   ...
   * @memberof ModelClass
   */
  static async getById(id, subscriptionCallback) {
    const documentRef = await this._collectionRef
      .doc(id)

    if (subscriptionCallback) {
      documentRef.onSnapshot(documentSnap => {
   ...
   * @memberof ModelClass
   */
  static async getBy(key, value, subscriptionCallback) {
    const query = await this._collectionRef
      .where(key, '==', value)
   ...
   * @memberof ModelClass
   */
  static async getAllBy(key, value, optionalModifiers, subscriptionCallback) {
